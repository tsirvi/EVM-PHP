...
<div class="content py-5">
    <h3 class="text-center"><b>Our locations</b></h3>
    <hr class="w-25 border-light">
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="input-group mb-2">
                <input type="search" id="search" class="form-control form-control-border" placeholder="Search locations here...">
    ...
    <?php if($halls->num_rows < 1): ?>
        <center><span class="text-muted">No locations Listed Yet.</span></center>
    <?php endif; ?>
