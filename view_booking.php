...
<div class="container-fluid">
    <div id="outprint" class="list-group">
        <div class="row">
            ...
            <div class="col-4 bg-gradient-maroon border">location:</div>
            ...
            <div class="col-4 bg-gradient-maroon border">Event Schedule:</div>
            <div class="col-8 text-dark border"><?= isset($event_schedule) ? date("M d, Y h:i A", strtotime($event_schedule)) : "N/A" ?></div>
