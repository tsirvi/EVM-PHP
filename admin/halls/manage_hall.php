...
<div class="container-fluid">
    <form action="" id="hall-form">
        ...
        <div class="form-group">
            <label for="code" class="control-label">event</label>
            <input type="text" pattern="[0-9A-Za-z_-]+" maxlength="50" name="code" id="code" class="form-control form-control-border" placeholder="event name" value ="<?php echo isset($code) ? $code : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="name" class="control-label">Name</label>
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter place Name" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
        ...
        <!-- <div class="form-group">
            <label for="" class="control-label">location Image</label>
