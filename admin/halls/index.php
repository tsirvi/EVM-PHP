...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New location","halls/manage_hall.php")
		})
        $('.edit_data').click(function(){
			uni_modal("Update location Details","halls/manage_hall.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this location permanently?","delete_hall",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Location Details","halls/view_hall.php?id="+$(this).attr('data-id'))
		})
